...
INSERT INTO vehicle_variants (vehicle_id, name, sku, color, price, battery_capacity_kwh, battery_type, battery_spec, range_km, is_active) VALUES
(1, 'Standard Red', 'SPARK-STD-RED', 'Red', 89999.00, NULL, 'Lithium Ion', '60V / 30AH', 110, 1),
(1, 'Pro Black', 'SPARK-PRO-BLK', 'Black', 99999.00, NULL, 'Lithium Ion', '72V / 30AH', 140, 1);
